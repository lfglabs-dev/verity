...
| VaultFromSolidity | 15 | Proof-only import | `Contracts/VaultFromSolidity/Proofs/` |
...
> **Note**: Stdlib (0 internal proof-automation properties) is excluded from the contract-spec theorem table above but included in overall coverage statistics (344 total properties).
...
| VaultFromSolidity | 0% (0/15) | 15 proof-only |
| ERC721 | 100% (11/11) | 0 |
...
**Status**: 74% coverage (255/344), 89 remaining exclusions all proof-only
