...
| VaultFromSolidity | 8 | Proof-only import | `Contracts/VaultFromSolidity/Proofs/` |
...
> **Note**: Stdlib (0 internal proof-automation properties) is excluded from the contract-spec theorem table above but included in overall coverage statistics (337 total properties).
...
| VaultFromSolidity | 0% (0/8) | 8 proof-only |
| ERC721 | 100% (11/11) | 0 |
...
**Status**: 76% coverage (255/337), 82 remaining exclusions all proof-only

- **Total Properties**: 337
- **Covered**: 255
- **Excluded**: 82 (all proof-only)
