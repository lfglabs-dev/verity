...
| SolidityImportSmoke | 19 | Proof-only import | `Contracts/SolidityImportSmoke/` |
...
> **Note**: Stdlib (0 internal proof-automation properties) is excluded from the contract-spec theorem table above but included in overall coverage statistics (355 total properties).
...
| SolidityImportSmoke | 0% (0/19) | 19 proof-only |
| ERC721 | 100% (11/11) | 0 |
...
**Status**: 72% coverage (255/355), 100 remaining exclusions all proof-only

- **Total Properties**: 355
- **Covered**: 255
- **Excluded**: 100 (all proof-only)
