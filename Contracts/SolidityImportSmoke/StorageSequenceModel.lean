...
namespace SolidityImportSmoke.StorageSequenceModel
open Compiler.CompilationModel
solidity_import imported from "Contracts/SolidityImportSmoke" entry "StorageSequence.sol"
...
end SolidityImportSmoke.StorageSequenceModel
...
def main (args : List String) : IO UInt32 := do
  ...
  | ["compile", selectorsFile, output] =>
      ...
      let compiled ← IO.ofExcept (Compiler.CompilationModel.compile
        SolidityImportSmoke.StorageSequenceModel.model selectors .osaka)
  ...
  | _ =>
      Compiler.CompilationModel.SolidityImport.SequenceRunner.run
        SolidityImportSmoke.StorageSequenceModel.model SolidityImportSmoke.StorageSequenceModel.oracle args
