...
namespace SolidityImportSmoke.StorageBytesSequenceModel
open Compiler.CompilationModel
solidity_import imported from "Contracts/SolidityImportSmoke" entry "StorageBytesSequence.sol"
...
end SolidityImportSmoke.StorageBytesSequenceModel
...
def main (args : List String) : IO UInt32 := do
  ...
  | ["compile", selectorsFile, output] =>
      ...
      let compiled ← IO.ofExcept (Compiler.CompilationModel.compile
        SolidityImportSmoke.StorageBytesSequenceModel.model selectors .osaka)
  ...
  | _ =>
      Compiler.CompilationModel.SolidityImport.SequenceRunner.run
        SolidityImportSmoke.StorageBytesSequenceModel.model SolidityImportSmoke.StorageBytesSequenceModel.oracle args
