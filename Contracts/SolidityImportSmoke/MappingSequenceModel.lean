...
namespace SolidityImportSmoke.MappingSequenceModel
open Compiler.CompilationModel
solidity_import imported from "Contracts/SolidityImportSmoke" entry "MappingSequence.sol"
...
end SolidityImportSmoke.MappingSequenceModel
...
def main (args : List String) : IO UInt32 := do
  ...
  | ["compile", selectorsFile, output] =>
      ...
      let compiled ← IO.ofExcept (Compiler.CompilationModel.compile
        SolidityImportSmoke.MappingSequenceModel.model selectors .osaka)
  ...
  | _ =>
      Compiler.CompilationModel.SolidityImport.SequenceRunner.run
        SolidityImportSmoke.MappingSequenceModel.model SolidityImportSmoke.MappingSequenceModel.oracle args
