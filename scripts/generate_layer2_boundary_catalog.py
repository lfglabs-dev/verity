            ...
            "helper_boundary": {
                ...
                "source_helper_goal_surface": {
                    ...
                    "status": (
                        ...
                        "supported_function_body_correct_from_exact_state_"
                        "generic_split_internal_helper_surface_steps_and_helper_ir; the "
                        "compile-derived legacy-compatibility witness chain "
                        "(GenericInduction/LegacyCompatibility) is retired, so "
                        "the weaker compiled-side witness is now a "
                        "caller-supplied hypothesis while the weaker source "
                        "witness is still derived via "
                        "stmtListHelperFreeStepInterface_of_core, so "
                        "already-proved helper-free cases can still be reused "
                        "in the exact helper-aware compiled seam without "
                        ...
                        "the hypothesis-passing wrappers already route "
                        ...
                        "exact_state_generic_with_helpers_and_helper_ir_callsDisjoint"
                    ),
                },
                ...
                "current_fail_closed_gate": (
                    ...
                    "and Contract.lean exposes the hypothesis-passing "
                    "helper-aware whole-contract wrappers "
                    "compile_preserves_semantics_with_helper_proofs_and_helper_ir_closed "
                    "and compile_preserves_semantics_with_helper_proofs_and_helper_ir_goal "
                    "over a caller-supplied LegacyCompatibleRuntimeContract witness "
                    "(the compile-derived witness chain is retired with "
                    "GenericInduction/LegacyCompatibility). "
