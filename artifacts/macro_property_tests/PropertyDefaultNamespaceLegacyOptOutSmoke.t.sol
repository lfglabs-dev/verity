...
/**
 * @title PropertyDefaultNamespaceLegacyOptOutSmokeTest
 * @notice Auto-generated baseline property stubs from `verity_contract` declarations.
 * @dev Source: Contracts/Smoke.lean
 */
contract PropertyDefaultNamespaceLegacyOptOutSmokeTest is YulTestBase {
    address target;
    address alice = address(0x1111);

    function setUp() public {
        target = deployYul("DefaultNamespaceLegacyOptOutSmoke");
